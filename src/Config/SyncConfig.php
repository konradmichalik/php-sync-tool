...
final readonly class SyncConfig
{
    ...
    public function __construct(
        ...
        public bool $backupBeforeImport = false,
        public string $importFile = '',
        public string $tables = '',
        public string $where = '',
        public string $additionalDumpOptions = '',
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            backupBeforeImport: ConfigAccessor::getBool($data, 'backup_before_import', false),
            ...
            additionalDumpOptions: ConfigAccessor::getString($data, 'additional_dump_options', '', 'additional_mysqldump_options'),
            ...
            checkForUpdates: ConfigAccessor::getBool($data, 'check_for_updates', false),
